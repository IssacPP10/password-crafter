  ...
  return (
    <div className='mt-5 max-w-2xl'>
        <div className='relative w-full'>
            ...
            <Copy className='absolute top-3 right-12 cursor-pointer h-5 w-5' onClick={() => copyClipboard(itemValueInput, toast)} />
            <Shuffle className='absolute top-3 right-4 cursor-pointer h-5 w-5' onClick={handleShuffleClick} />
        </div>
